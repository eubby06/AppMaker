...
$destination_folder     = dirname(__FILE__) . '/uploads/'; //upload directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
    ...
    if($image_res){
        ...
        if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
        {
            ...
            echo '<img src="http://spinn.dev/server/uploads/'.$thumb_prefix . $new_file_name.'" alt="Thumbnail">';
            echo '<br />';
            echo '<img src="http://spinn.dev/server/uploads/'. $new_file_name.'" alt="Resized Image">';
            echo '</div>';
        }
