                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                {{ Form::open(array('route' => 'get.roles.create','role' => 'form')) }}
                                    <div class="box-body">
                                        ...
                                        <div class="form-group {{ $errors->first('type') ? 'has-error' : '' }}">
                                            <label>Type</label>
                                            {{ Form::select('type', array('access'=>'Access','manage'=>'Manage'), Input::old('type'), array('class' => 'form-control')
                                            ) }}
                                        </div>
                                        ...
                                        <div class="form-group {{ $errors->first('app_id') ? 'has-error' : '' }}">
                                            ...
                                            {{ Form::select('app_id', $apps, Input::old('app_id'), array('class' => 'form-control')
                                            ) }}
                                        </div>
                                    </div><!-- /.box-body -->
