...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SPINN Application Maker</title>
        ...
        <!-- Morris chart -->
         ...
         {{ HTML::style('css/ionslider/ion.rangeSlider.css') }}
         {{ HTML::style('css/ionslider/ion.rangeSlider.skinFlat.css') }}
         {{ HTML::style('css/ionslider/ion.rangeSlider.skinNice.css') }}
        <!-- jvectormap -->
        ...
        <!-- bootstrap wysihtml5 - text editor -->
         ...
         <!-- loading overlay -->
         {{ HTML::style('css/overlay/style.css') }}
        <!-- Theme style -->
        ...
        <!-- Custom style -->
         ...
         <!-- Jquery File Upload -->
         {{ HTML::style('css/file-upload/jquery.fileupload.css') }}
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="{{ route('get.dashboard.index') }}" class="logo">
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
                <img src="{{ asset('img/spinn-logo.png') }}">
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>{{ App::make('AccessControl')->getUser()->fullname() }} <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        {{ App::make('AccessControl')->getUser()->fullname() }}
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{ route('get.users.edit', App::make('AccessControl')->getUser()->_id) }}" class="btn btn-default btn-flat"><i class="fa fa-edit"></i> Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="{{ route('get.login.logout') }}" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>{{ Request::segment(1) }} <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="user-body">
                                    <div class="col-xs-4 text-center">
                                        <a href="{{ switchLanguageUrl('en') }}">English</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="{{ switchLanguageUrl('zh') }}">Chinese</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        {{ HTML::script('js/plugins/jquery/jquery-2.1.1.js') }}
        ...
        {{ HTML::script('js/plugins/logicify/locationpicker.jquery.js') }}
        <!-- jvectormap -->
        ...
        <!-- overlay script  -->
        {{ HTML::script('js/plugins/overlay/itpoverlay.js') }}
        ...
        {{ HTML::script('js/plugins/handlebar/handlebars-latest.js') }}
